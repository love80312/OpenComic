...
function set(key, value, save = true)
{
	switch (key)
	{
		...
		case 'disableTapZones': 
			...
			dom.queryAll('.settings-body .settings-tap-zones, .settings-body .settings-invert-tap-zones-in-manga, .settings-body .settings-middle-click-auto-scroll-in-all-tap-zones').class(value, 'disable-pointer');
			dom.queryAll('.settings-body .settings-middle-click-auto-scroll-in-center-tap-zone').class(config.middleClickAutoScrollInAllTapZones, 'disable-pointer');

			break;

		case 'middleClickAutoScrollInAllTapZones':

			dom.queryAll('.settings-body .settings-middle-click-auto-scroll-in-center-tap-zone').class(value, 'disable-pointer');
